  ...
  return (
    <>
      ...
      <div className="slidercontainer">
          ...
          <CardActionArea>
            ...
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary">
                The Indian Institutes of Technology (IITs) are central
                government-owned-public technical institutes located across
                India.
              </Typography>
            </CardContent>
          </CardActionArea>
        ...
        <Card className="card" sx={{ maxWidth: 345 }}>
          <CardActionArea>
            <CardMedia component="img" height="140" image={IITG} alt="IITD" />
            <CardContent>
              <Typography gutterBottom variant="h5" component="div">
                IITD
              </Typography>
